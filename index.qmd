...
### Module 2: Data Import and Export
  ...
  - SAS data set import (`haven` package) and writ xpt files 
  - Exporting data frames to various formats( rds,.RData)
  - other formats (JSON, XML)
  
### Module 3: Data Manipulation - dplyr and tidyr
...
- **Advanced Data Manipulation**
  ...
  - Date and time handling (`lubridate` vs SAS date functions)
